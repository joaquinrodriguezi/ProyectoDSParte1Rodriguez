...
* responde siempre en españoldentificar qué variables numéricas tienen mayor peso o mayo
* ir influencia en el precio de un auto utilizando un modelo de Random Forest.
